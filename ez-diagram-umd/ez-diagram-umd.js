(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Ez = {}));
    ...
    ***************************************************************************** */
    ...
    })(exports.EzDirection || (exports.EzDirection = {}));
    ...
    var EzConstraint = /** @class */ (function () {
        ...
        EzConstraint.createByDirection = function (direction) {
            switch (direction) {
                case exports.EzDirection.LEFT:
                    return new EzConstraint(0, 0.5);
                case exports.EzDirection.TOP:
                    return new EzConstraint(0.5, 0);
                case exports.EzDirection.RIGHT:
                    return new EzConstraint(1, 0.5);
                case exports.EzDirection.BOTTOM:
    ...
    var EzModel = /** @class */ (function () {
        ...
        EzModel.prototype.setLayoutChild = function (parent, child, direction, connectEdge) {
            if (direction === void 0) { direction = exports.EzDirection.BOTTOM; }
            ...
            if (connectEdge) {
                switch (direction) {
                    case exports.EzDirection.BOTTOM:
                        this.connect(connectEdge, parent, exports.EzDirection.BOTTOM, child, exports.EzDirection.TOP);
                        break;
                    case exports.EzDirection.LEFT:
                        this.connect(connectEdge, parent, exports.EzDirection.LEFT, child, exports.EzDirection.RIGHT);
                        break;
                    case exports.EzDirection.TOP:
                        this.connect(connectEdge, parent, exports.EzDirection.TOP, child, exports.EzDirection.BOTTOM);
                        break;
                    case exports.EzDirection.RIGHT:
                        this.connect(connectEdge, parent, exports.EzDirection.RIGHT, child, exports.EzDirection.LEFT);
                        break;
                }
            }
        };
    ...
    var TreeLayout = /** @class */ (function (_super) {
        ...
        function TreeLayout() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this._direction = exports.EzDirection.BOTTOM;
            _this._config = { nodeSpacing: 20, layerSpacing: 30 };
            return _this;
        }
        Object.defineProperty(TreeLayout.prototype, "_isVertical", {
            get: function () {
                return this._direction === exports.EzDirection.TOP || this._direction === exports.EzDirection.BOTTOM;
            },
            enumerable: false,
            configurable: true
        });
            ...
            var updateChildren = function (parent, layer) {
                ...
                children.forEach(function (child) {
                    ...
                    edges.forEach(function (edge) {
                        switch (_this._direction) {
                            case exports.EzDirection.LEFT:
                                _this.diagram.model.changeConstraint(edge, exports.EzDirection.LEFT, true);
                                _this.diagram.model.changeConstraint(edge, exports.EzDirection.RIGHT, false);
                                break;
                            case exports.EzDirection.TOP:
                                _this.diagram.model.changeConstraint(edge, exports.EzDirection.TOP, true);
                                _this.diagram.model.changeConstraint(edge, exports.EzDirection.BOTTOM, false);
                                break;
                            case exports.EzDirection.RIGHT:
                                _this.diagram.model.changeConstraint(edge, exports.EzDirection.RIGHT, true);
                                _this.diagram.model.changeConstraint(edge, exports.EzDirection.LEFT, false);
                                break;
                            case exports.EzDirection.BOTTOM:
                                _this.diagram.model.changeConstraint(edge, exports.EzDirection.BOTTOM, true);
                                _this.diagram.model.changeConstraint(edge, exports.EzDirection.TOP, false);
                                break;
                        }
                    });
                });
        ...
        TreeLayout.prototype.executeLayout = function () {
            var _this = this;
            [exports.EzDirection.TOP, exports.EzDirection.BOTTOM, exports.EzDirection.LEFT, exports.EzDirection.RIGHT].forEach(function (direction) {
    ...
    ***************************************************************************** */
    ...
    exports.BUILTIN_ACTIONS = BUILTIN_ACTIONS;
    exports.BUILTIN_MARKER = BUILTIN_MARKER;
    exports.BUILTIN_SHAPE = BUILTIN_SHAPE;
    exports.COLOR_TRANSPARENT_WHITE = COLOR_TRANSPARENT_WHITE;
    exports.COLOR_WHITE = COLOR_WHITE;
    exports.EZ_DIAGGRAM_DEFAULT_CONFIG = EZ_DIAGGRAM_DEFAULT_CONFIG;
    exports.EZ_VIEW_EDGE_CLASS = EZ_VIEW_EDGE_CLASS;
    exports.EZ_VIEW_VERTEX_CLASS = EZ_VIEW_VERTEX_CLASS;
    exports.EditableVertexShape = EditableVertexShape;
    exports.EzConstraint = EzConstraint;
    exports.EzDiagram = EzDiagram;
    exports.EzDiagramActions = EzDiagramActions;
    exports.EzDiagramView = EzDiagramView;
    exports.EzEdge = EzEdge;
    exports.EzEdgeShape = EzEdgeShape;
    exports.EzElement = EzElement;
    exports.EzLineShape = EzLineShape;
    exports.EzMath = math;
    exports.EzModel = EzModel;
    exports.EzPoint = EzPoint;
    exports.EzRectangle = EzRectangle;
    exports.EzRectangleShape = EzRectangleShape;
    exports.EzShape = EzShape;
    exports.EzShapeManager = EzShapeManager;
    exports.EzVertex = EzVertex;
    exports.EzVertexShape = EzVertexShape;
    exports.HTML_NAME_SPACE = HTML_NAME_SPACE;
    exports.Layout = index;
    exports.Plugin = index$1;
    exports.SVG_NAME_SPACE = SVG_NAME_SPACE;
    exports.Style = style;
    exports.getBoundingBoxFromPoints = getBoundingBoxFromPoints;
    exports.getCenterPoint = getCenterPoint;
    exports.getDotProduct = getDotProduct;
    exports.getIncludedAngleOfTwoVector = getIncludedAngleOfTwoVector;
    exports.getNormOfVector = getNormOfVector;
    exports.getRotatedPoint = getRotatedPoint;
    exports.getScalarMulOfVector = getScalarMulOfVector;
    exports.getUnitVector = getUnitVector;
    exports.getVector = getVector;
    exports.getVectorEndPoint = getVectorEndPoint;
    exports.getVectorProjection = getVectorProjection;
    exports.isPointInsideRect = isPointInsideRect;
    exports.toRadians = toRadians;
    exports.toRectPoints = toRectPoints;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ez-diagram-umd.js.map
